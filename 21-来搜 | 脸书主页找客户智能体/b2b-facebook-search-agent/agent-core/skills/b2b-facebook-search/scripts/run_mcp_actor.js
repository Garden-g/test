 ...
 *
 * This script intentionally does not read APIFY_TOKEN. It relies on the user's
 * logged-in mcpc Apify session, usually named @apify.
 */
...
function parseCliArguments() {
    ...
    if (values.help) {
        console.log('Usage: node scripts/run_mcp_actor.js --actor ACTOR --input JSON --output raw.csv --json-output raw.json');
        process.exit(0);
    }
