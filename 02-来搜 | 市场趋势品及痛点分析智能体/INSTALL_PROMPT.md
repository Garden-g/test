...
/Users/garden/Self/TokenMindOmni/delivery/合作交付/磐西/Accio Work/智能体安装包/02-来搜 | 市场趋势品及痛点分析智能体/alibaba-store-product-selection-planner-agent.zip
...
本包声明的插件依赖：alibaba-com-seller-assistant、spreadsheets。插件依赖不代表目标环境已经安装或授权。
```
