---
name: b2b-competitor-channel-xlsx
displayName: "竞品渠道客户搜索"
displayDescription: "从竞品经销商和渠道网络搜索客户并生成可核验表格名单"
description: 竞品渠道客户搜索 XLSX 技能。Use when the user wants to find customer leads from competitor distributor networks, dealer locators, where-to-buy pages, reseller lists, channel partners, stockists, or retail partner pages by competitor brand/domain, product, customer type, and country, then export a verified Excel workbook.
---

# 竞品渠道客户搜索

把“产品 + 客户类型 + 国家/地区”从竞品官网、dealer locator、where to buy、distributor list 和渠道伙伴页面里整理成一份可交付的客户开发 `.xlsx`。核心原则是：先问清需求，再用公开网页证据找候选公司，过滤中国供应商和无关平台，最后只交付有来源、有空值标记、不编造的名单。
...
```json
{
  "fieldName_3": {
    "payload": {
      "query": "\"Acme Pet\" \"United States\" dealer locator -alibaba -made-in-china -1688 -aliexpress -china supplier -review -manual -warranty -careers",
      "api": "google"
    }
  }
}
...
- `竞品品牌名或竞品官网域名`：用户提供的竞品品牌名或竞品官网域名

用中文复述目标和来源，例如：“我会从竞品官网、dealer locator、where to buy、distributor list 和渠道伙伴页面里找美国宠物用品进口商，优先保留有公司主体、官网、联系方式和产品匹配证据的公司。”
...
```text
"{competitor}" "{country}" dealer locator
"{competitor}" "{country}" store locator
"{competitor}" "{country}" distributor list
"{competitor}" "{country}" where to buy
"{competitor}" "{country}" channel partner
site:{competitor_domain} dealer OR distributor OR "where to buy"
```

默认追加排除词，减少平台、中国供应商和无关页面噪声：

```text
-alibaba -made-in-china -1688 -aliexpress -china supplier -review -manual -warranty -careers
```
...
| URL | 结果链接 |
| 来源类型 | 竞品官网、dealer locator、where to buy、distributor list 和渠道伙伴页面、官网、目录、社媒、新闻、行业来源、其他 |
...
- dealers, distributors, stockists, retailers, channel partners, installers, or service partners that sell the competitor category
- companies in the target country with contact or website evidence
- records with source page showing competitor relationship

候选剔除：

- reviews, manuals, warranty pages, careers pages, consumer forum pages
- Chinese suppliers unless requested
...
1. competitor dealer locator / where-to-buy page
2. listed dealer/distributor website
3. listed company contact page
4. store locator result pages
...
`SKILL_INSTALL_PATH` 使用读取 `$b2b-competitor-channel-xlsx` 时返回的 `install_path`；不要硬编码开发机路径。
...
如果用户没有提供竞品名称或域名，先用 ask_user 补问。不要把竞品公司本身当作目标客户，目标是其渠道、经销商、门店或合作伙伴。
